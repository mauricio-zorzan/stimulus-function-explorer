...
def test_draw_composite_rectangular_grid_l_shape():
    ...
    file_name = draw_composite_rectangular_grid_with_dashed_lines(l_shape)
...
def test_draw_composite_rectangular_grid_overlap():
    ...
    file_name = draw_composite_rectangular_grid_with_dashed_lines(overlap)
    assert os.path.exists(file_name)
...
def test_draw_composite_rectangular_grid_json_payload():
    ...
    file_name = draw_composite_rectangular_grid_with_dashed_lines(payload)
    assert os.path.exists(file_name)
